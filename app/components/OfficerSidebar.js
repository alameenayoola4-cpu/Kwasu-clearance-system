...
// Shared Officer Sidebar Component with Mobile Hamburger Menu
    ...
    return (
        <>
            ...
            <div className="mobile-header">
                ...
                <Link href="/officer" className="mobile-logo">
                ...
                <div className="sidebar-header">
                    <Link href="/officer" className="sidebar-logo">
                        ...
                        <div className="sidebar-logo-text">
                            ...
                            <span className="logo-subtitle">OFFICER PORTAL</span>
                        </div>
                    </Link>
                </div>

                <nav className="sidebar-nav">
                    <Link href="/officer" className={`nav-item ${isActive('/officer') && pathname === '/officer' ? 'active' : ''}`} onClick={() => setIsOpen(false)}>
                    ...
                    <Link href="/officer/requests" className={`nav-item ${isActive('/officer/requests') ? 'active' : ''}`} onClick={() => setIsOpen(false)}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <Link href="/officer/reports" className={`nav-item ${isActive('/officer/reports') ? 'active' : ''}`} onClick={() => setIsOpen(false)}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" />
                        </svg>
                        Reports
                    </Link>
                    <Link href="/officer/settings" className={`nav-item ${isActive('/officer/settings') ? 'active' : ''}`} onClick={() => setIsOpen(false)}>
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
